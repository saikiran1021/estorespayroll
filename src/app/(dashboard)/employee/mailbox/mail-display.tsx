    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
      <Tabs defaultValue="inbox" className="md:col-span-1">
        <TabsList className="grid w-full grid-cols-2">
          <TabsTrigger value="inbox"><Inbox className="mr-2" /> Inbox ({receivedMail.length})</TabsTrigger>
          <TabsTrigger value="sent"><Send className="mr-2" /> Sent ({sentMail.length})</TabsTrigger>
        </TabsList>
                    ...
                    <div className="flex flex-col h-full">
                        <div className="flex items-center p-2">
                            ...
                            <div className="ml-4 grid gap-1">
                                <p className="text-sm font-semibold">{selectedMail.senderEmail}</p>
