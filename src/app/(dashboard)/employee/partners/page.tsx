...
function PartnersTable({ userType }: { userType: 'colleges' | 'industries' }) {
        ...
        <CardHeader>
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <CardDescription>
                View registered College and Industry partners.
              </CardDescription>
            </div>
          </div>
        </CardHeader>
          ...
          <Tabs defaultValue="colleges">
            ...
            <TabsContent value="colleges">
              <Card>
                ...
                <CardContent>
                  <PartnersTable userType="colleges" />
                </CardContent>
              </Card>
            </TabsContent>
            <TabsContent value="industries">
              <Card>
                ...
                <CardContent>
                  <PartnersTable userType="industries" />
                </CardContent>
              </Card>
            </TabsContent>
          </Tabs>
